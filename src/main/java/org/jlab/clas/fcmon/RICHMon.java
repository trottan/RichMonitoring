 ...
 * @author kenjo
 */
public class RICHMon implements IDataEventListener, DetectorListener { //extends DetectorMonitor implements IDataEventListener, DetectorListener {

    JPanel mainPanel;
    public  JTabbedPane tabPanel;
    private  DataSourceProcessorPane processorPane;
    private  RichView detectorView;
    private  CLASDecoder clasDecoder = new CLASDecoder();
    ...
    private  JLabel evntLbl = new JLabel();

    private  RichPlot[] richPlots = {
        new RichPlotOccupancy(),
        new RichPlotTDC(),
        new RichPlotMultiplicity()
    };

    public RICHMon(String name){
      //super(name);
      mon();
   }
