...
public final class RichPlotOccupancy extends RichPlot {
    ...
    public final RichPanel evdisPanel = new RichPanel();
    public final JCheckBox evdisBox;
    public Boolean evdisMode = false;
    Map<Integer, RichPixWeight> hits = new ConcurrentHashMap<>();
    TColorPalette colPalette = new TColorPalette();
    public double scaleWeight = 1;
    public int leadingMin = 0, leadingMax = 300, trailingMin = 0, trailingMax = 300, deltaMin = 0, deltaMax = 150;
    public int npmts = 0;

    public final JLabel evntLbl = new JLabel();
    public final RichView detectorView;
    ...
    public RichPlotOccupancy(){
        ...
        splitPane.setRightComponent(evdisPanel); // this is the panel we need
